      ...
      <main className='relative z-10 w-full max-w-5xl px-6 flex flex-col items-center text-center gap-10 py-20'>
        ...
        <div className='space-y-6 max-w-3xl animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-150 fill-mode-both'>
          <h1 className='text-5xl sm:text-7xl font-extrabold tracking-tight'>
            Welcome to{" "}
            <span className='text-transparent bg-clip-text bg-linear-to-r from-primary to-blue-500 drop-shadow-sm'>
              MOS
            </span>
          </h1>
          <div className='relative'>
            <span className='absolute -top-6 -left-4 sm:-left-8 text-6xl text-primary/20 font-serif'>
              "
            </span>
            <p className='text-lg sm:text-2xl text-muted-foreground font-medium leading-relaxed italic px-4'>
              Empowering seamless collaboration between brands and
              manufacturers. From the first order to the final delivery, we
              provide the tools to manage it all.
            </p>
            <span className='absolute -bottom-8 -right-4 sm:-right-8 text-6xl text-primary/20 font-serif'>
              "
            </span>
          </div>
        </div>
        ...
        <div className='pt-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 fill-mode-both'>
          <Link href='/home'>
            <Button
              size='lg'
              className='h-14 px-8 text-lg font-bold rounded-2xl shadow-xl shadow-primary/25 hover:scale-105 hover:shadow-2xl hover:shadow-primary/40 transition-all duration-300 group'
            >
              Get Started
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-6 w-full max-w-4xl mt-12 sm:mt-24 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500 fill-mode-both'>
          <div className='flex flex-col items-center text-center p-6 rounded-3xl bg-card/60 border border-border/50 shadow-sm backdrop-blur-sm hover:-translate-y-1 transition-transform duration-300'>
            ...
            <p className='text-sm text-muted-foreground leading-relaxed'>
              Connect with certified manufacturers and scale your brand
              worldwide with ease.
            </p>
          </div>
          <div className='flex flex-col items-center text-center p-6 rounded-3xl bg-card/60 border border-border/50 shadow-sm backdrop-blur-sm hover:-translate-y-1 transition-transform duration-300'>
            ...
            <p className='text-sm text-muted-foreground leading-relaxed'>
              Gain full visibility into your orders at every critical stage of
          ...
          <div className='flex flex-col items-center text-center p-6 rounded-3xl bg-card/60 border border-border/50 shadow-sm backdrop-blur-sm hover:-translate-y-1 transition-transform duration-300'>
            ...
            <p className='text-sm text-muted-foreground leading-relaxed'>
              Built with enterprise-grade security to protect your business data
              and partnerships.
            </p>
          </div>
        </div>
